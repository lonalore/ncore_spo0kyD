...
var Content = function () {
  ...
  (0, _createClass3.default)(Content, [{
    ...
    value: function capture() {
      ...
      if ($spooky.length > 0) {
        var $spookyImg = $spooky.find('img');

        var offset = $spookyImg.offset();
        var event = new _jquery2.default.Event("click");
    ...
    key: 'captured',
    value: function captured($spooky) {
      var _this = this;
      var $closeBtn = $spooky.find('#removeMessage');
      var $reCaptcha = (0, _jquery2.default)('div.g-recaptcha');

      // Captcha has been detected!
      if ($reCaptcha.length > 0) {
        _this.captchaSolver().then(function () {
          $reCaptcha.closest('form').submit();
        }).catch(function (error) {
          // console.log(error);
        });
      } else if ($closeBtn.length > 0) {
        var text = _this.extractText($spooky);
        if (text) {
          _this.store(text);
        }

        var closeBtnOffset = $closeBtn.offset();
        var closeEvent = new _jquery2.default.Event("click");
    ...
    key: 'captchaSolver',
    value: function captchaSolver() {
      var _this = this;

      return new _promise2.default(function (resolve, reject) {
        _this.config.getPromised('captchaAccessToken', "").then(function (accessToken) {
          ...
          var $gReCaptcha = (0, _jquery2.default)('div.g-recaptcha');
          var $captchaRes = (0, _jquery2.default)('input[name="captcha_response"]');
          ...
          var CAPTCHA_ACCESS_TOKEN = accessToken;
          var CAPTCHA_SITE_KEY = $gReCaptcha.attr('data-sitekey');
          var CAPTCHA_PAGE_URL = window.location.href;
          var CAPTCHA_USER_AGENT = navigator.userAgent;
    ...
    value: function store(text) {
      ...
      _this.storage.get('captured-figures', false, function (result) {
        ...
        _this.storage.set('captured-figures', (0, _stringify2.default)(history));
      });
    }
  }]);
  return Content;
...
/* WEBPACK VAR INJECTION */(function($) {window.bestcaptchasolver_config = {
